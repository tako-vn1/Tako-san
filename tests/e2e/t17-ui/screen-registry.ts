...
export const SCREEN_REGISTRY: RegisteredScreen[] = [
  ...
  },
  {
    ...
    auth: 'session',
    contract: { heading: /Nhà mình thường có bao nhiêu người ăn/ },
    nav: 'hidden',
    source: 'reviewer-verified-kit',
  },
  {
    ...
    auth: 'session',
    contract: { heading: /Nhà mình thích món gì và cần tránh gì/ },
    nav: 'hidden',
    source: 'reviewer-verified-kit',
  },
  {
    ...
    auth: 'session',
    contract: { heading: /Bạn muốn Takosan giúp việc gì trước/ },
    nav: 'hidden',
    source: 'reviewer-verified-kit',
  },
  {
